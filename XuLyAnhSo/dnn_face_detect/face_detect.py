...
if __name__ == "__main__":
    ...
    if args.image1 is not None:
        ...
        if args.image2 is not None:
            ...
            print(
                "They have {}. Cosine Similarity: {}, threshold: {} (higher value means higher similarity, max 1.0).".format(
                    msg, cosine_score, cosine_similarity_threshold
                )
            )
            ...
            if l2_score <= l2_similarity_threshold:
                msg = "the same identity"
            print(
                "They have {}. NormL2 Distance: {}, threshold: {} (lower value means higher similarity, min 0.0).".format(
                    msg, l2_score, l2_similarity_threshold
                )
            )
        cv.waitKey(0)
